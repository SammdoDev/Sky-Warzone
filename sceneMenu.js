var sceneMenu = new Phaser.Class({
  ...
  create: function () {
    ...
    // FIXED: Cek apakah ambience sound sudah ada dan sedang dimainkan
    // Hanya buat sekali dan mainkan sekali
    if (!this.sound.get("snd_ambience")) {
      ...
      this.ambienceSound = this.sound.get("snd_ambience");
      if (!this.ambienceSound.isPlaying) {
        this.ambienceSound.play();
      }
    }

    // FIXED: bgMusic menggunakan referensi yang sama dengan ambienceSound
    // untuk menghindari duplikasi
    this.bgMusic = this.ambienceSound;
    ...
    // REMOVED: Duplicate sound creation - sudah dibuat di atas
